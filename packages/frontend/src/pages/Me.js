...
export const MePage = () => {
  return (
    ...
    >
      <div className="w-screen md:h-screen bg-slate-400 flex flex-col items-center justify-center">
        <div className="w-4/5 p-2 bg-white my-2">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="mx-2">
              ...
              <p>
                ...
                humanity through the development of technology for good. My
                dream is of a future where toil and repetitive tasks are a thing
                of the past, where humans can focus on doing meaningful stuff
                and let the machines do things that are boring, repetitive or
                dangerous.
              </p>
              <p className="mt-2">
              ...
              <p className="mt-2">
                ...
                people time and makes our world ever more productive and
                efficient than ever, leaving us with more time to do the things
                that really matter.
              </p>
            </div>
          </div>
          ...
          <h1 className="mx-1">
            I'm also interested in how the world works, how we live within it
            and how we can improve our quality of life through the development
            of technology.
          </h1>
