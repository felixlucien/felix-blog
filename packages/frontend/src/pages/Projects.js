            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="w-80">
                ...
                <h1>
                  ...
                  Everyone adds stuff in their own time and the next time
                  someone goes, they just grab all the things on the list.
                </h1>
              </div>
            ...
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/2">
                ...
                <h1>
                  ...
                  autocomplete textfield ui component and I desperately needed
                  one for the aforementioned ShareShop app.
                </h1>
                <h1 className="font-bold">The solution</h1>
                <h1>
            ...
            <div className="flex flex-row">
              <div>
                ...
                <h1>
                  ...
                  pins, allowing the ESP 8266 to act as a bridge from wired
                  medium to wireless, nice! I had to mess around with the LWIP
                  stack and implemented a cool command prompt so you could issue
                  router commands, for example:
                </h1>
